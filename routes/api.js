...
loghandler = {
    notparam: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'parámetros de entrada de apikey',
        getApikey: '¿¿¿Clave API??? Contáctame por WhatsApp'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'parámetros clave de entrada'
    },
    noturl: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'parámetros de la URL de entrada'
    },
    notkata: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'parámetro de palabra de entrada'
    },
    nottext: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'parámetros de entrada de texto'
    },
    nottext2: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'parámetros de entrada text2'
    },
    notnabi: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'ingrese el parámetro de profeta'
    },
    nottext3: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'parámetro de entrada text3'
    },
    nottheme: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'ingrese los parámetros del tema'
    },
    notusername: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Ingrese los parámetros del nombre de usuario'
    },
    notvalue: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'valores de los parámetros de entrada'
    },
    notheme: {
    	status: false,
        creator: `${creator}`,
        code: 406,
        message: 'el tema no está disponible, ingrese texmaker / ver o lea la documentación'
     },
    invalidKey: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: '¿¿¿Clave API??? Contáctame por WhatsApp'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
        message: 'error, tal vez su enlace no sea válido.'
    },
    invalidkata: {
        status: false,
        creator: `${creator}`,
        message: 'error, tal vez la palabra no esté en el fuego.'
    },
    notAddApiKey: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'parámetro de estado de entrada, apikeyInput, correo electrónico, número de teléfono, nombre, edad, país, exp'
    },
    error: {
        status: false,
        creator: `${creator}`,
        message: 'tal vez esté siendo reparado'
    }
}

const listkey = ["rimuru", "6otosaka9"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'rimuru') return res.json(loghandler.invalidKey)
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'rimuru')  return res.json(loghandler.invalidKey)
